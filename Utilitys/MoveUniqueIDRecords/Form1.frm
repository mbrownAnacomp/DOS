...
Function CheckClaimPrefix(sClaimPrefix As String) As Boolean
    If sClaimPrefix = "A" Or sClaimPrefix = "F" Or sClaimPrefix = "D" Or sClaimPrefix = "V" Or sClaimPrefix = "I" Then
        CheckClaimPrefix = True
    Else
        CheckClaimPrefix = False
    End If
End Function
