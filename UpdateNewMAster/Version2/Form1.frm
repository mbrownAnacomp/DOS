...
Private Sub cmdUpload_Click()
    ...
    Set tsOut = fs.OpenTextFile(App.Path & "\DoS_NewMaster.sql", ForAppending, True)
...
Private Sub cmdUploadVM_Click()
    ...
    Set fs = New FileSystemObject
    Set tsOut = fs.OpenTextFile(App.Path & "\DoS_VM_NewMaster.sql", ForAppending, True)
