...
Friend Class frmBrowseOtherNOA
    ...
    Private Sub cmdBrowseNOA_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdBrowseNOA.Click
        ...
        ' Set filters
        CommonDialog1.Filter = "All Other NOA Code Dictionary File (*.txt)|*.txt"
        ' Specify default filter
        CommonDialog1.FilterIndex = 1
        CommonDialog1.Title = "Select All Other NOA Code Dictionary File"
...
Error_Dir:
    ...
    Private Sub cmdSave_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSave.Click
        ...
        If UCase(VB.Right(Me.txtBrowseNOA.Text, 4)) = ".TXT" Then
            If UCase(Me.txtBrowseNOA.Text) <> UCase(sHoldOtherNOA) Then
                lRet = MsgBox("New NOA Code Dictionary file location will be active once program has been restarted", MsgBoxStyle.OkCancel, "Warning!")
                If lRet = MsgBoxResult.Cancel Then
                    Exit Sub
                Else
                    sOtherNOADir = Me.txtBrowseNOA.Text
                    Me.Close()
                End If
            Else 'No change
                Me.Close()
        ...
        End If
    End Sub
    Private Sub frmBrowseOtherNOA_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.txtBrowseNOA.Text = sOtherNOADir
        sHoldOtherNOA = Me.txtBrowseNOA.Text
    End Sub
End Class